...
class ManejadorListarPersonasTest {
    ...
    void setUp() {
        ...
        this.servicioListarPersonas =
                Mockito.mock(ServicioListarPersonas.class);

        this.fabricaPersona =
                Mockito.mock(FabricaPersona.class);

        this.manejadorListarPersonas =
                new ManejadorListarPersonas(
                        servicioListarPersonas,
                        fabricaPersona);
    }
    ...
    void debeRetornarListaVaciaCuandoNoExistenPersonas() {
        ...
        when(this.servicioListarPersonas.ejecutar())
                .thenReturn(new ArrayList<>());

        List<PersonaDTO> resultado =
                this.manejadorListarPersonas.ejecutar();
